    ...
    <div className='mx-5 my-5'>
        <div className='flex  gap-5 justify-end '>
            ...
            <div className='bg-blue-700 h-[300px] w-[500px]  relative rounded-md'>
               ...
               />
               <h1 className='text-white font-bold w-[50%] pt-10 ml-5 text-2xl'>Sports Car with Best Design and Acceleration</h1>
               <p className='text-white font-light mt-5 ml-5 w-[70%]'>Safety and Comfort while driving Futuristic and eligent Sport Car</p>
