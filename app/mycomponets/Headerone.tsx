...
const Headerone = () => {
  return<div className=' mt-10 bg-gray-200 '>
<div className='flex gap-10 justify-center'>
    ...
    <div className=' two w-[640px] h-[360px] bg-blue-700 rounded-md  relative'>
    ...
    <div className='flex gap-10 justify-end mx-5 mt-6  '>
      <div className='w-[450px] h-[140px] border border-gray-500 bg-white px-5'>
      ...
      <div className='w-[450px] h-[140px] border border-gray-500'>

      <div className=' h-[132px] border  bg-white px-5'>
